...
public class LocaleActivity extends TextViewActivity {
  ...
  static String describeLocale(String name) {
    ...
    if (hasLocaleData) {
      ...
      try {
        ...
        describeStringArray(result, "amPm", enUsData, localeData);
        describeStringArray(result, "eras", enUsData, localeData);
        result.append('\n');
        
        describeStringArray(result, "longMonthNames", enUsData, localeData);
        describeStringArray(result, "longStandAloneMonthNames", enUsData, localeData);
        describeStringArray(result, "shortMonthNames", enUsData, localeData);
        describeStringArray(result, "shortStandAloneMonthNames", enUsData, localeData);
        describeStringArray(result, "tinyMonthNames", enUsData, localeData);
        describeStringArray(result, "tinyStandAloneMonthNames", enUsData, localeData);
        result.append('\n');
        
        describeStringArray(result, "longWeekdayNames", enUsData, localeData);
        describeStringArray(result, "longStandAloneWeekdayNames", enUsData, localeData);
        describeStringArray(result, "shortWeekdayNames", enUsData, localeData);
        describeStringArray(result, "shortStandAloneWeekdayNames", enUsData, localeData);
        describeStringArray(result, "tinyWeekdayNames", enUsData, localeData);
        describeStringArray(result, "tinyStandAloneWeekdayNames", enUsData, localeData);
        result.append('\n');
  ...
  private static void describeStringArray(StringBuilder sb, String fieldName, Object enUsData, Object localeData) {
    try {
